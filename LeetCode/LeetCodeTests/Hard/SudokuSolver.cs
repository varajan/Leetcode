...
namespace LeetCodeTests.Hard
{
    ...
    {
        private static LeetCode.Hard.SudokuSolver Solver => new LeetCode.Hard.SudokuSolver();

        [TestMethod]
        public void SudokuSolver_01()
        {
            var board = new[]
            {
                new[] {'5', '3', '.', '.', '7', '.', '.', '.', '.'},
